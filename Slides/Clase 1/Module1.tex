...
\frametitle{El Marco: Agente y Ambiente}
 \centering
 \mode<beamer>{
    \only<1>{\includegraphics[width=1\textwidth]{../Images/RL/RL0.jpg}}
    \only<2>{\includegraphics[width=1\textwidth]{../Images/RL/RL1.png}}
    \only<3>{\includegraphics[width=1\textwidth]{../Images/RL/RL2.png}}}
    \only<4->{\includegraphics[width=1\textwidth]{../Images/RL/RL3_new.jpg}}
...
\centering
\mode<beamer>{
    \only<2>{\includegraphics[width=0.75\textwidth]{../Images/Market/Market1.png}}
    \only<3>{\includegraphics[width=0.75\textwidth]{../Images/Market/Market2.png}}
    \only<4>{\includegraphics[width=0.75\textwidth]{../Images/Market/Market3.png}}
    \visible<5->{\includegraphics[width=0.75\textwidth]{../Images/Market/Market4.png}}
}
\end{frame}
...
\begin{columns}[t]
    ...
    \begin{column}{0.35\textwidth}
        \centering
        \mode<beamer>{
            \only<1,3>{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess1.png}}
            \only<2>{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess2.png}}
            \only<4>{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess3.png}}
            \only<5>{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess4.png}}
            \only<6>{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess5.png}}
            \only<7->{\includegraphics[width=\textwidth]{../Images/MarkovProcess/MarkovProcess1.png}}
        }
    \end{column}
\end{columns}
...
\begin{center}
    \mode<beamer>{
        \only<3>{\includegraphics[width=0.7\textwidth]{../Images/Market/Market4.png}}
        \only<4->{\includegraphics[width=0.45\textwidth]{../Images/Market/MarketWithReward.png}}
    }
\end{center}
